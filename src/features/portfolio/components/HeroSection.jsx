  ...
  return (
    <section className="flex flex-col gap-12">
      ...
      <div className="space-y-8 text-center md:text-left">
        ...
        <p className="text-xl font-medium text-slate-300 break-keep">
          <span className="text-2xl sm:text-3xl font-black text-[#f8fafc] mr-2">
            서버가 다운되어도 제 멘탈은 다운되지 않습니다.
          </span>
          <br/>특유의 긍정 에너지와 집요함으로 할당된 이슈를 반드시 박살 내는 백엔드 개발자 정채림입니다! 
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-start gap-12">
        ...
        <div className="flex-1 space-y-8 text-center md:text-left w-full">
          <img 
            src="/profile.jpg" 
            alt="정채림 프로필" 
            className="w-full max-w-lg h-[400px] sm:h-[450px] md:h-[480px] object-cover brutal-border brutal-shadow mx-auto md:mx-0"
          />
        ...
        <div className="w-full md:w-1/2 flex justify-center pb-10 md:pb-0">
          <div className="relative w-full max-w-lg h-[400px] sm:h-[450px] md:h-[480px] bg-[#1e293b] p-8 sm:p-10 brutal-border brutal-shadow font-mono text-base sm:text-lg">
            {/* Top Bar */}
